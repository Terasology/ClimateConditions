...
/**
 * Handles effects related to Hypothermia. Hypothermia occurs in case of extremely low body temperature and, e.g., slows
 * the player's movements. For adding new effects in existing or new Hypothermia Levels, {@link
 * HypothermiaLevelChangedEvent} should be reacted to either in this or a separate authority system for eg. {@link
 * FrostbiteSystem}.
 */
