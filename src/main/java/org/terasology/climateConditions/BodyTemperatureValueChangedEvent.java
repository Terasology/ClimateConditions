 ...
 * Value. Changes in Body Temperature Value are also used to check if Body Temperature Level should be changed. Body
 * Temperature Levels corresponding to the Body Temperature Value ranges can be found in {@link
